    ...
    pub fn write_binary(self, data: Points) -> std::io::Result<()> {
        ...
        let mut ply = {
            ...
            for entry in data.get_data() {
                ...
                point.insert("x".to_string(), Property::Float(entry.point_coord.x));
                point.insert("y".to_string(), Property::Float(entry.point_coord.y));
                point.insert("z".to_string(), Property::Float(entry.point_coord.z));
                point.insert("red".to_string(), Property::UChar(entry.point_color.red));
                point.insert("green".to_string(), Property::UChar(entry.point_color.green));
                point.insert("blue".to_string(), Property::UChar(entry.point_color.blue));
                points.push(point);
            }
