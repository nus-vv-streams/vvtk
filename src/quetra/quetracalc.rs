...
pub struct QuetraCalc {
    ...
    pub selected_bitrate: f32,
}

trait RateAdaptation {
    fn description(&self) -> String;
    fn get_buffer_occupancy(&self) -> f32;
    fn select_bitrate(&self) -> f32;
}

impl RateAdaptation for QuetraCalc {
    fn description(&self) -> String {
        return format!("This algorithm uses {}, with buffer_occupancy {} resulting in a selected_bitrate of {}.", self.name, self.buffer_occupancy, self.selected_bitrate);
    }
