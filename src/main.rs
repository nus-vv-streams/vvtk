...
fn main() {
    ...
    let (a, reference, marked_interpolated_frame) = data_1051.closest_with_ratio_average_points_recovery(&data_1053, 49.5/100.0, 49.5/100.0, 1.0/100.0, 0.7, 400, false, false, false, false); //sum of first 3 must equal 1
